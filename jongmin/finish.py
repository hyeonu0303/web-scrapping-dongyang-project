...
def fHumidity(humidity):
    if humidity >= 30 and humidity <= 60:
        return ["습도가 적정합니다.", "기쁜표정.png"]
    elif humidity < 30:
        return ["습도가 너무 낮습니다. 가습기를 사용하는 것이 좋습니다.", "슬픈표정.png"]
    elif humidity > 60:
        return ["습도가 너무 높습니다. 제습기를 사용하는 것이 좋습니다.", "슬픈표정.png"]
    else:
        return ["자료없음"]
...
def fRainfall(rainfall):
    if rainfall == 0:
        ...
        return ["약한 비가 와요!", "놀란표정.png"]
    elif rainfall >= 3.0 and rainfall < 15.0:
        return ["적당한 비가 내려요!", "놀란표정.png"]
    elif rainfall >= 15.0:
        return ["강한 비가 내리니 외출을 자제하세요!", "슬픈표정.png"]
    elif rainfall >= 30.0:
        return ["매우 강한 비가 내리니 외출하지마세요!", "슬픈표정.png"]
    else:
        print("자료없음")
